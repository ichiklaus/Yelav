...
export default function Portfolio() {
  ...
  const personal_projects = t.raw('personal_projects') as PortfolioProps[];

  const projects = personal_projects.sort(function (a, b) {
  ...
  return (
    <section id='projects' className='pt-32 -mt-32'>
      <AnimatePresence>
        <header>
          <h2 className='font-bold text-accent mb-6'>{t('projects_section.title')}</h2>
        </header>
